...
const patternVisualMap = {
  ...
  "Commutative Property (Multiply)":
    "assets/gifs/commutativepropertymultiply.gif",
  ...
  "Curved Surface Area of Cylinder":
    "assets/gifs/curvedsurfaceareacylinder.gif",
  ...
  // Visuals for advanced patterns
  "Euler's Formula": "assets/gifs/eulersformula.gif",
  "Taylor Series": "assets/gifs/taylorsseries.gif",
  "Maclaurin Series": "assets/gifs/maclaurinseries.gif",
  "L'Hôpital's Rule": "assets/gifs/lhopitalsrule.gif",
  "Implicit Differentiation": "assets/gifs/implicitdifferentiation.gif",
  "Second Derivative Test": "assets/gifs/secondderivativetest.gif",
  "Logarithmic Differentiation": "assets/gifs/logarithmicdifferentiation.gif",
  "Double Angle (Sine)": "assets/gifs/doubleanglesine.gif",
  "Double Angle (Cosine)": "assets/gifs/doubleanglecosine.gif",
  "Triple Angle Formula": "assets/gifs/tripleangleformula.gif",
  "Determinant of 2x2 Matrix": "assets/gifs/determinantof2x2matrix.gif",
  "Cramer's Rule": "assets/gifs/cramersrule.mp4",
  Eigenvalues: "assets/gifs/eigenvalues.gif",
  "Matrix Inverse": "assets/gifs/matrixinverse.gif",
  "Dot Product": "assets/gifs/dotproduct.gif",
  "Cross Product": "assets/gifs/crossproduct.gif",
  "Vector Magnitude": "assets/gifs/vectormagnitude.gif",
  "Gradient Vector": "assets/gifs/gradientvector.gif",
  Divergence: "assets/gifs/divergence.gif",
  "Curl of Vector Field": "assets/gifs/curlvectorfield.gif",
  "Laplace Transform": "assets/gifs/laplacetransform.gif",
  "Fourier Series": "assets/gifs/fourierseries.gif",
  "Limit Definition of Derivative":
    "assets/gifs/limitdefinitionofderivative.gif",
  FTC: "assets/gifs/fundamentaltheoremofcalculus.gif",
  "Chain Rule (Multivariable)": "assets/gifs/chainrulemultivariable.gif",
  "2nd Order ODE": "assets/gifs/2ndorderode.gif",
  "Homogeneous ODE": "assets/gifs/homogeneousode.gif",
  "Bernoulli ODE": "assets/gifs/bernoulliode.gif",
  "Separable Variables": "assets/gifs/separablevariables.gif",
  "Binomial Theorem": "assets/gifs/binomialtheorem.gif",
  "Mean Value Theorem": "assets/gifs/meanvaluetheorem.gif",
  "Rolle's Theorem": "assets/gifs/rollestheorem.gif",
  "Polar → Rectangular": "assets/gifs/polartorectangular.gif",
  "Rectangular → Polar": "assets/gifs/rectangulartopolar.gif",
  "Parabola Equation": "assets/gifs/parabolaequation.gif",
  "Ellipse Equation": "assets/gifs/ellipseequation.gif",
  "Hyperbola Equation": "assets/gifs/hyperbolaequation.gif",
  "Binomial Probability": "assets/gifs/binomialprobability.gif",
  "Poisson Distribution": "assets/gifs/poissondistribution.gif",
  "Z-score": "assets/gifs/zscore.gif",
  Variance: "assets/gifs/variance.gif",
  "Standard Deviation": "assets/gifs/standarddeviation.gif",
  Covariance: "assets/gifs/covariance.gif",
  "Correlation Coefficient": "assets/gifs/correlationcoefficient.gif",
  "Bayes' Theorem": "assets/gifs/bayestheorem.gif",
  Permutation: "assets/gifs/permutation.gif",
  Combination: "assets/gifs/combination.gif",
  "Expected Value": "assets/gifs/expectedvalue.gif",
  "Partial Derivative": "assets/gifs/partialderivative.gif",
  "Double Integral": "assets/gifs/doubleintegral.gif",
  "Triple Integral": "assets/gifs/tripleintegral.gif",
  "Jacobian Determinant": "assets/gifs/jacobiandeterminant.gif",
  "Parametric Equations": "assets/gifs/parametricequations.gif",
  "Lagrange Interpolation": "assets/gifs/lagrangeinterpolation.gif",
  "Newton's Divided Difference": "assets/gifs/newtonsdifferencedifference.gif",
  "Gradient Descent": "assets/gifs/gradientdescent.gif",
  "Fourier Transform": "assets/gifs/fouriertransform.gif",
  "Complex Number": "assets/gifs/complexnumber.gif",
  "Modulus of Complex": "assets/gifs/modulusofcomplex.gif"
  // Add more patterns and their corresponding visuals as needed
};
let synth = null;
let scheduledEvents = [];
